...
function App() {
  ...
  return (
    <main className={`min-h-screen ${bgClass} ${textClass} flex flex-col p-4`}>
      <ThemeToggle />
      <CookieConsent />
      ...
      <div className="w-full max-w-4xl mx-auto flex-1 flex flex-col">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <div className="text-center mb-8">
            <p className={`text-lg ${textSecondaryClass} mb-2`}>
              Fyll i från och tilldatum för att ta reda på antal dagar du behöver ta ledigt <span className="text-2xl">{seasonTheme.emoji}</span>
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex items-end">
            <button
              ...
              className={`w-full sm:w-auto px-8 py-2 ${seasonTheme.primaryColor} ${seasonTheme.primaryColorHover} text-white font-semibold rounded-lg transition-colors duration-200`}
            >
              Beräkna
            </button>
          </div>
        ...
        <footer className={`pt-12 pb-4 text-center ${textSecondaryClass} text-sm space-y-2`}>
